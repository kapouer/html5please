...
[Engine.io](https://github.com/LearnBoost/engine.io) is a Node.js framework that helps with downlevel transports for browsers lacking native WebSocket support (and supports IE6+).
